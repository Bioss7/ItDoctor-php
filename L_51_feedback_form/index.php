...
<head>
    ...
    <title>#51 Уроки PHP - Учим язык PHP, Форма обратной связи на языке PHP и отправка письма на почту</title>
</head>
<body>
    <form action="sandmail.php" method="POST">
        ...
        <textarea name="message" placeholder="Введите ваше сообщение" maxlength="150" required></textarea>
        <label for="">7*8</label>
